...
class Boot4LeaderPropertiesBindingTest {

    @Test
    fun `yaml 형식 키를 Boot4LeaderProperties에 바인딩`() {
        ...
        val props = Binder(source).bindAs<Boot4LeaderProperties>("bluetape4k.leader").get()
