...
import io.bluetape4k.leader.spring.boot4.backend.ExposedJdbcLeaderConfiguration
import io.bluetape4k.leader.spring.boot4.backend.ExposedR2dbcLeaderConfiguration
import io.bluetape4k.leader.spring.boot4.backend.HazelcastLeaderConfiguration
import io.bluetape4k.leader.spring.boot4.backend.LettuceLeaderConfiguration
import io.bluetape4k.leader.spring.boot4.backend.MongoLeaderConfiguration
import io.bluetape4k.leader.spring.boot4.backend.RedissonLeaderConfiguration
...
/**
 * bluetape4k-leader Spring Boot 4 자동 구성 진입점.
 *
 ...
 * 모든 백엔드 평가 후 활성화됩니다.
 *
 * @see Boot4LeaderProperties yaml `bluetape4k.leader.*` 속성 바인딩
 */
@AutoConfiguration
