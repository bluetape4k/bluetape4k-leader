...
dependencies {
    ...
    // 6 backend factory 등록 위해 backend 모듈이 classpath 에 있어야 함 (AutoConfig 가 @ConditionalOnClass 로 가드)
    ...
    // [T4.1a Option A][issue #1050] spring-boot-starter-aop 미추가 — @EnableAspectJAutoProxy 만으로 활성화
