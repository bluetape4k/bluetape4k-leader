...
const strictRouteGateSlugs = new Set([
  ...
  "examples-batch-scheduler-flow-01",
  "examples-batch-scheduler-scenario-01",
  "examples-k8s-operator-architecture-01",
  "examples-cache-warmer-flow-01",
  "examples-cache-warmer-scenario-01",
  "examples-consul-maintenance-flow-01",
  "examples-consul-maintenance-scenario-01",
  "examples-dynamodb-export-architecture-01",
  "examples-dynamodb-export-flow-01",
  "examples-dynamodb-export-scenario-01",
  "examples-etcd-reconciler-flow-01",
  "examples-etcd-reconciler-scenario-01",
  "examples-k8s-lease-flow-01",
  "examples-k8s-lease-scenario-01",
  "examples-k8s-operator-flow-01",
  "examples-k8s-operator-scenario-01",
  "examples-ktor-app-architecture-01",
  "examples-ktor-app-flow-01",
  "examples-ktor-app-scenario-01",
  "examples-migration-gate-architecture-01",
  "examples-migration-gate-flow-01",
  "examples-migration-gate-scenario-01",
  "examples-prometheus-dashboard-flow-01",
  "examples-prometheus-dashboard-scenario-01",
  "examples-rate-limiter-architecture-01",
  "examples-rate-limiter-flow-01",
  "examples-rate-limiter-scenario-01",
  "examples-redisson-watchdog-flow-01",
  "examples-redisson-watchdog-scenario-01",
  "examples-strategic-election-flow-01",
  "examples-strategic-election-scenario-01",
  "examples-tenant-aggregator-architecture-01",
  "examples-tenant-aggregator-flow-01",
  "examples-tenant-aggregator-scenario-01",
  "examples-virtual-thread-runner-flow-01",
  "examples-virtual-thread-runner-scenario-01",
  "examples-webhook-poller-architecture-01",
  "examples-webhook-poller-flow-01",
  "examples-webhook-poller-scenario-01",
...
function listSvgFiles() {
  ...
  return sh("find", [diagramDir, "-maxdepth", "1", "-name", "*.svg", "-print"])
    ...
    .filter((path) => !checkOnly || existsSync(path.replace(/\.svg$/, ".png")))
    .sort();
}
