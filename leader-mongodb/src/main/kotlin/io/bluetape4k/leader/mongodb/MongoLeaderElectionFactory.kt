...
/**
 * [MongoLeaderElection] 팩토리 — MongoDB sync 클라이언트 기반 단일 리더 선출.
 *
 * ## 사용 예
 * ```kotlin
 ...
 */
class MongoLeaderElectionFactory(
    ...
    override fun create(options: LeaderElectionOptions): LeaderElection =
        MongoLeaderElection(collection, baseOptions.copy(leaderOptions = options))
}
