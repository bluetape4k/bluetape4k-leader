 ...
 */
class MongoLeaderGroupElection private constructor(
    ...
    companion object : KLogging() {
        ...
        operator fun invoke(
            ...
            return MongoLeaderGroupElection(groupCollection, options)
        }
    }
...
fun <T> MongoCollection<Document>.runIfLeaderGroup(
    ...
    options: MongoLeaderGroupElectionOptions = MongoLeaderGroupElectionOptions.Default,
    action: () -> T,
): T? = MongoLeaderGroupElection(this, options).runIfLeader(lockName, action)
...
fun <T> MongoCollection<Document>.runAsyncIfLeaderGroup(
    ...
    options: MongoLeaderGroupElectionOptions = MongoLeaderGroupElectionOptions.Default,
    action: () -> CompletableFuture<T>,
): CompletableFuture<T?> = MongoLeaderGroupElection(this, options).runAsyncIfLeader(lockName, executor, action)
