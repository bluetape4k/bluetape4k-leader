...
class LocalStrategicLeaderElectorTest {
    ...
    private lateinit var node1: LocalStrategicLeaderElector
    private lateinit var node2: LocalStrategicLeaderElector
    private lateinit var node3: LocalStrategicLeaderElector

    @BeforeEach
    fun setup() {
        node1 = LocalStrategicLeaderElector("node-1")
        node2 = LocalStrategicLeaderElector("node-2")
        node3 = LocalStrategicLeaderElector("node-3")
    }

    private fun registerAll(vararg nodes: LocalStrategicLeaderElector, registeredAt: Instant = Instant.now()) {
