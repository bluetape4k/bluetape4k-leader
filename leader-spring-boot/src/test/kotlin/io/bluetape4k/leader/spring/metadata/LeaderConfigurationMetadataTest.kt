...
class LeaderConfigurationMetadataTest {
    ...
    fun `configuration metadata contains diagnostics backend and management properties`() {
        listOf(
            ...
            "bluetape4k.leader.route-guard.redirect.enabled",
            "bluetape4k.leader.route-guard.redirect.allowed-hosts",
            "bluetape4k.leader.route-guard.redirect.trusted-proxy-addresses",
            "bluetape4k.leader.route-guard.redirect.lease-safety-window",
    ...
    fun `configuration metadata defaults match property classes`() {
        mapOf(
            ...
            "bluetape4k.leader.route-guard.redirect.enabled" to "false",
            "bluetape4k.leader.route-guard.redirect.allowed-hosts" to "",
            "bluetape4k.leader.route-guard.redirect.trusted-proxy-addresses" to "",
            "bluetape4k.leader.route-guard.redirect.lease-safety-window" to "PT0S",
