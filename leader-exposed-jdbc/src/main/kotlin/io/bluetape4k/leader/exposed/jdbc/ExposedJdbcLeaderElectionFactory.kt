...
/**
 * [ExposedJdbcLeaderElection] 팩토리 — Exposed JDBC 기반 단일 리더 선출.
 *
 * ## 사용 예
 * ```kotlin
 ...
 */
class ExposedJdbcLeaderElectionFactory(
    ...
    override fun create(options: LeaderElectionOptions): LeaderElection =
        ExposedJdbcLeaderElection(db, baseOptions.copy(leaderOptions = options))
}
