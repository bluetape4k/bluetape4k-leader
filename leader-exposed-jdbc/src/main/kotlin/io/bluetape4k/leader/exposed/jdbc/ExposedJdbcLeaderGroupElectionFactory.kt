...
/**
 * [ExposedJdbcLeaderGroupElection] 팩토리 — Exposed JDBC 기반 다중 리더 선출.
 *
 * ## 사용 예
 * ```kotlin
 ...
 */
class ExposedJdbcLeaderGroupElectionFactory(
    ...
    override fun create(options: LeaderGroupElectionOptions): LeaderGroupElection =
        ExposedJdbcLeaderGroupElection(db, baseOptions.copy(leaderGroupOptions = options))
}
