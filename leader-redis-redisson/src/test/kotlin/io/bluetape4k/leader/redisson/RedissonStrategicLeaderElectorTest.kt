...
class RedissonStrategicLeaderElectorTest: AbstractRedissonLeaderTest() {
    ...
    private lateinit var node3: RedissonStrategicLeaderElector

    @BeforeEach
    fun setup() {
        node1 = RedissonStrategicLeaderElector(redissonClient, "node-1")
        node2 = RedissonStrategicLeaderElector(redissonClient, "node-2")
        node3 = RedissonStrategicLeaderElector(redissonClient, "node-3")
    }
