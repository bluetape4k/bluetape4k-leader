...
- **조정 백엔드:** Lettuce Redis가 리더 선출 상태를 저장하고 락 소유권을 관리합니다.
...
2. `BatchSchedulerDemo`에서 클라이언트 생성, 후보 구성, 결과 출력 순서를 따라갑니다.
...
이 워크숍은 Lettuce Redis 백엔드를 실행 가능한 Gradle 애플리케이션에 연결합니다. 예제는 학습에 필요한 로컬 실행 환경을 준비합니다. 운영에서는 백엔드 클라이언트를 주입하고 애플리케이션 생명주기에 맞춰 닫아야 합니다.
...
### Batch scheduler 아키텍처

[![Batch scheduler 아키텍처](../../assets/readme-diagrams/examples-batch-scheduler-architecture-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-architecture-01.svg)

_배포본 README: [`examples/batch-scheduler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/batch-scheduler/README.ko.md)_

### Batch scheduler 처리 흐름

[![Batch scheduler 처리 흐름](../../assets/readme-diagrams/examples-batch-scheduler-flow-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-flow-01.svg)

_배포본 README: [`examples/batch-scheduler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/batch-scheduler/README.ko.md)_

### Batch scheduler 실행 시나리오 다이어그램

[![Batch scheduler 실행 시나리오 다이어그램](../../assets/readme-diagrams/examples-batch-scheduler-scenario-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-scenario-01.svg)

_배포본 README: [`examples/batch-scheduler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/batch-scheduler/README.ko.md)_

### Batch scheduler 시퀀스 다이어그램

[![Batch scheduler 시퀀스 다이어그램](../../assets/readme-diagrams/examples-batch-scheduler-sequence-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-sequence-01.svg)
