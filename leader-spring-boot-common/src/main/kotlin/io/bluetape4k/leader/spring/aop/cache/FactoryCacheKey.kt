...
/**
 * AOP 어드바이스의 [io.bluetape4k.leader.LeaderElection] 캐싱 키.
 *
 ...
 * 재사용 위험을 회피한다.
 *
 * @property factoryBeanName Spring [io.bluetape4k.leader.LeaderElectionFactory] 빈 이름
...
/**
 * AOP 어드바이스의 [io.bluetape4k.leader.LeaderGroupElection] 캐싱 키.
 *
 * @property factoryBeanName Spring [io.bluetape4k.leader.LeaderGroupElectionFactory] 빈 이름
